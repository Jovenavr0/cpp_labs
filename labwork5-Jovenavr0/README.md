[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=13121526&assignment_repo_type=AssignmentRepo)
...
2. Ограничение по памяти на класс - (x_axis_ * y_axis_ * z_axis_ * 17)/8 + const, где x_axis_, y_axis_, z_axis_ - размер массива, const - некоторая константа
